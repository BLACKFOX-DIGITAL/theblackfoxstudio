...
export const ContainerScroll = ({ titleComponent, children }) => {
  ...
  return (
    ...
    >
      <div
        className="   w-full relative lg:pt-60"
        style={{
          perspective: "1000px",
        }}
      >
...
export const Card = ({ rotate, scale, children }) => {
  return (
    <motion.div
      ...
      className=" hidden lg:block lg:max-w-[53.333vw] -mt-12 mx-auto     w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
