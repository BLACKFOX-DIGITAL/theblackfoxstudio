export const services = [
  ...
  },
  {
    ...
    beforeImage: '/model-retouch-full-before.png',
    afterImage: '/model-retouch-full-after.png',
  ...
  },
  {
    ...
    beforeImage: '/handbag-before.png?v=2',
    afterImage: '/handbag-after.png?v=2',
    heroImage: '/multi-clipping-path-hero.png',
    order: 14,
    status: 'PUBLISHED'
  },
  {
  ...
  },
  {
    ...
    beforeImage: '/car-suv-before.png',
    afterImage: '/car-suv-after.png',
    heroImage: '/car-hero.png',
    order: 16,
    status: 'PUBLISHED'
  },
  {
  ...
  },
  {
    ...
    beforeImage: '/packshot-hero-before.png',
    afterImage: '/packshot-hero-after.png',
    heroImage: '/packshot-hero-after.png',
    order: 18,
    status: 'PUBLISHED'
  },
  {
  ...
  },
  {
    ...
    heroImage: '/restoration-hero-after.png',
    beforeImage: '/restoration-torn-before.png',
    afterImage: '/restoration-torn-after.png',
    order: 20,
    status: 'PUBLISHED'
  }
];
...
export const portfolio = [
  ...
  { id: 'p8', title: 'Silk Dress Digital Ironing', category: 'model-retouching-service', serviceName: 'Model Retouching', beforeImage: '/model-dress-before.png', afterImage: '/model-dress-after.png', featured: true },
  { id: 'p8b', title: 'Posture & Silhouette Harmony', category: 'model-retouching-service', serviceName: 'Model Retouching', beforeImage: '/model-posture-before.png', afterImage: '/model-posture-after.png', featured: true },
  { id: 'p8d', title: 'Editorial Hair Management', category: 'model-retouching-service', serviceName: 'Model Retouching', beforeImage: '/model-hair-before.png', afterImage: '/model-hair-after.png', featured: true },
  { id: 'p8e', title: 'Swimwear Skin & Body Polish', category: 'model-retouching-service', serviceName: 'Model Retouching', beforeImage: '/model-swimsuit-before.png', afterImage: '/model-swimsuit-after.png', featured: true },
  ...
  { id: 'p10b', title: 'Diamond Solitaire Polish', category: 'jewelry-retouching-service', serviceName: 'Jewelry Retouch', beforeImage: '/jewelry-ring-before.png', afterImage: '/jewelry-ring-after.png', featured: true },
  { id: 'p10c', title: '18k Gold Chain Masking', category: 'jewelry-retouching-service', serviceName: 'Jewelry Retouch', beforeImage: '/jewelry-chain-before.png', afterImage: '/jewelry-chain-after.png', featured: true },
  { id: 'p10d', title: 'Pearl Luster Enhancement', category: 'jewelry-retouching-service', serviceName: 'Jewelry Retouch', beforeImage: '/jewelry-pearls-before.png', afterImage: '/jewelry-pearls-after.png', featured: true },
  ...
  { id: 'p20', title: 'Vintage Portrait Reconstruction', category: 'photo-restoration-service', serviceName: 'Photo Restoration', beforeImage: '/restoration-torn-before.png', afterImage: '/restoration-torn-after.png', featured: true },
  { id: 'p20b', title: 'Faded Memory Recovery', category: 'photo-restoration-service', serviceName: 'Photo Restoration', beforeImage: '/restoration-faded-before.png', afterImage: '/restoration-faded-after.png', featured: true },
  { id: 'p20c', title: 'Moldy Archive Preservation', category: 'photo-restoration-service', serviceName: 'Photo Restoration', beforeImage: '/restoration-mold-before.png', afterImage: '/restoration-mold-after.png', featured: true },
  { id: 'p20d', title: 'Historical Colorization Mastery', category: 'photo-restoration-service', serviceName: 'Photo Restoration', beforeImage: '/restoration-color-before.png', afterImage: '/restoration-color-after.png', featured: true },
  { id: 'p21', title: 'Luxury Leather Component Isolation', category: 'multi-clipping-path-service', serviceName: 'Multi-Clipping', beforeImage: '/handbag-before.png?v=2', afterImage: '/handbag-after.png?v=2', featured: true },
  { id: 'p21d', title: 'Furniture Mesh SKU Variation', category: 'multi-clipping-path-service', serviceName: 'Multi-Clipping', beforeImage: '/chair-before.png?v=2', afterImage: '/chair-after.png?v=2', featured: true },
  { id: 'p21e', title: 'Technical Sneaker Multi-Path', category: 'multi-clipping-path-service', serviceName: 'Multi-Clipping', beforeImage: '/sneaker-multipath-before.png', afterImage: '/sneaker-multipath-after.png', featured: true },
  { id: 'p21f', title: 'Extreme Cycle Masking', category: 'multi-clipping-path-service', serviceName: 'Multi-Clipping', beforeImage: '/bike-multipath-before.png', afterImage: '/bike-multipath-after.png', featured: true },
  { id: 'p22', title: 'Matte Tech Surface Polish', category: 'packshot-retouching-service', serviceName: 'Packshot Retouch', beforeImage: '/packshot-electronics-before.png', afterImage: '/packshot-electronics-after.png', featured: true },
  { id: 'p22b', title: 'Cylindrical Label Leveling', category: 'packshot-retouching-service', serviceName: 'Packshot Retouch', beforeImage: '/packshot-cosmetic-before.png', afterImage: '/packshot-cosmetic-after.png', featured: true },
  { id: 'p22c', title: 'Luxury Leather Grain Finish', category: 'packshot-retouching-service', serviceName: 'Packshot Retouch', beforeImage: '/packshot-footwear-before.png', afterImage: '/packshot-footwear-after.png', featured: true },
  { id: 'p22d', title: 'Precision Metallic Reflection', category: 'packshot-retouching-service', serviceName: 'Packshot Retouch', beforeImage: '/packshot-watch-before.png', afterImage: '/packshot-watch-after.png', featured: true },
  { id: 'p23', title: 'Luxury SUV Showroom Placement', category: 'car-photo-editing-service', serviceName: 'Car Photo Editing', beforeImage: '/car-suv-before.png', afterImage: '/car-suv-after.png', featured: true },
  { id: 'p23b', title: 'High-Speed Motion Blur Tech', category: 'car-photo-editing-service', serviceName: 'Car Photo Editing', beforeImage: '/car-sport-before.png', afterImage: '/car-sport-after.png', featured: true }
];
