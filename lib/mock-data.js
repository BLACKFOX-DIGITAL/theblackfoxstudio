export const services = [
  {
    ...
    shortDescription: 'Professional e-commerce photo editing for Amazon, Shopify & eBay. High-volume batch catalog retouching from $0.35/image. 24-hour delivery.',
    ...
    schemaDescription: 'Outsource e-commerce photo editing to BLACKFOX DIGITAL. Bulk catalog processing for Amazon, Shopify, and eBay sellers from $0.35/image. White label available. 24-hour turnaround.',
  ...
  },
  {
    ...
    schemaDescription: 'Outsource background removal to professional retouchers. Hand-drawn clipping paths and alpha channel masking for Amazon, Shopify, and print agencies starting at $0.29/image. Bulk orders welcome.',
  ...
  },
  {
    ...
    schemaDescription: 'Outsource clipping path service to BLACKFOX DIGITAL. Hand-drawn pen tool paths for pixel-perfect product isolation from $0.25/image. Bulk orders, white label, and agency pricing available. 24-hour delivery. Free trial — no credit card required.',
  ...
  },
  {
    ...
    shortDescription: 'Professional ghost mannequin and invisible mannequin service for fashion e-commerce. 3D hollow apparel visuals from $0.75/image. Next-day delivery.',
    ...
    schemaDescription: 'Outsource ghost mannequin and neck joint retouching for fashion e-commerce. Premium 3D invisible mannequin apparel shots from $0.75/image. Bulk pricing for high-volume apparel brands. Next-day delivery.',
  ...
  },
  {
    ...
    shortDescription: 'Advanced image masking for hair, fur, glass, and transparent objects. Alpha channel and layer masking from $0.75/image. 24-hour delivery.',
    description: '<p>When clipping paths fall short, image masking takes over. Hair, fur, feathers, smoke, and transparent glass are simply impossible to isolate cleanly with a rigid vector pen path — the edges are too fine, too complex, or semi-transparent. Our studio deploys three distinct masking disciplines: <strong>Alpha Channel Masking</strong> for luminance-based edge extraction on thin strands and wispy textures; <strong>Layer Masking</strong> for precise non-destructive control across multiple elements; and <strong>Refine Edge / Select & Mask</strong> workflows for the absolute finest hair and fur in high-resolution fashion and beauty photography. The result is a perfectly separated subject with every strand, filament, and transparency preserved in full commercial resolution — ready for any background, composite, or digital campaign.</p>',
    priceStarting: 0.75,
    priceUnit: 'image',
    turnaround: '24 hours',
    features: ['Alpha channel masking', 'Hair & fur strand preservation', 'Translucent glass & smoke isolation', 'Refine Edge / Select & Mask workflow'],
    pricingData: [
    ...
    h2Title: 'Advanced Hair Masking & Transparency Extraction Workflows',
    schemaDescription: 'Professional image masking services for hair, fur, glass, and transparent objects. Alpha channel masking and Refine Edge workflows starting at $0.75/image. 24-hour delivery. Trusted by 500+ global brands.',
  ...
  },
  {
    ...
    shortDescription: 'Professional drop shadow creation and mirror reflection rendering for product photography. Natural drop shadows, cast shadows, and acrylic reflections from $0.45/image.',
  ...
  },
  {
    ...
    shortDescription: 'Master-level beauty and skin retouching using frequency separation and dodge & burn. Editorial-grade results for cosmetics campaigns and magazines from $2.00/image.',
  ...
  },
  {
    ...
    shortDescription: 'Full-body fashion model retouching for apparel e-commerce and editorial. Garment wrinkle removal, skin tone correction, and natural body contouring from $1.99/image.',
  ...
  },
  {
    ...
    shortDescription: 'Commercial product photo retouching for electronics, furniture, and industrial goods. Defect removal, glare reduction, and label correction from $0.99/image. 24-hour delivery.',
  ...
  },
  {
    ...
    shortDescription: 'Master-level jewelry photo retouching for diamonds, gemstones, watches, and precious metals. Focus stacking, metal enhancement, and dust removal from $2.00/image. 48-hour delivery.',
  ...
  },
  {
    ...
    shortDescription: 'Professional color correction and digital recoloring for e-commerce and print. Pantone-accurate matching, exposure balancing, and multi-SKU color variants from $0.50/image.',
  ...
  },
  {
    ...
    shortDescription: 'Professional flatlay photo editing for fashion, lifestyle, and Instagram campaigns. Grid alignment, wrinkle removal, and background replacement from $1.50/image.',
  ...
  },
  {
    ...
    shortDescription: 'Expert multi-clipping path service for apparel, footwear, and furniture. Separate component layers for colorway SKU generation and multi-tone variations from $1.50/image.',
  ...
  },
  {
    ...
    shortDescription: 'Professional real estate photo editing for agents, MLS listings, and Airbnb. HDR blending, sky replacement, twilight conversion, and virtual decluttering from $1.50/image.',
  ...
  },
  {
    ...
    shortDescription: 'Professional automotive and car photo editing for dealerships and auto auctions. Paint correction, reflection removal, and digital showroom backgrounds from $3.00/image.',
  ...
  },
  {
    ...
    shortDescription: 'Professional 360-degree product photo editing for interactive spinners. Anti-flicker batch processing, rotational alignment, and rig removal from $0.50/frame.',
  ...
  },
  {
    ...
    shortDescription: 'Professional packshot retouching for FMCG, cosmetics, and supplements. Label realignment, carton correction, and Pantone color matching from $1.00/image. 24-hour turnaround.',
  ...
  },
  {
    ...
    shortDescription: 'Professional image web optimization for e-commerce and high-traffic sites. Lossless compression, WebP/AVIF conversion, and SEO alt-tag writing from $0.25/image.',
  ...
  },
  {
    ...
    shortDescription: 'Expert vintage photo restoration for damaged, torn, and faded prints. Tear repair, colorization, and archival recovery for families, museums, and libraries from $7.00/image.',
    description: '<p>Physical legacy prints inevitably degrade due to UV exposure, moisture damage, and acidic chemical breakdown. Our restoration studio specializes in taking your high-resolution digital scans of these decaying assets and mathematically reviving them. We meticulously clone out heavy physical tearing, meticulously rebuild entirely missing anatomical details (like eyes and faces) using complex structural mapping, neutralize aggressive chemical staining, and accurately colorize monochrome archives based on strict historical referencing. Whether you are preserving a single priceless family heirloom or digitally remastering a massive museum collection, we revive the past with absolute precision.</p>',
    priceStarting: 7.00,
    priceUnit: 'image',
    turnaround: '48-72 hours',
    features: ['Surgical physical tear & crease repair', 'Archival colorization & sepia neutralization', 'Missing structural pixel reconstruction', 'Water damage & mold stain removal'],
    pricingData: [
    ...
    h2Title: 'Archival Photo Recovery & Colorization Studio',
    schemaDescription: 'Expert photo restoration services for damaged vintage prints. Tear repair, mold/water stain removal, and historical colorization starting at $7.00/image.',
