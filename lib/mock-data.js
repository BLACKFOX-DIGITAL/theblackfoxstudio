...
export const portfolio = [
  ...
  { id: 'p8', title: 'Editorial Fashion Retouch', category: 'model-retouching-service', serviceName: 'Model Retouching', beforeImage: '/model-retouch-full-before.png', afterImage: '/model-retouch-full-after.png', featured: true },
  ...
  { id: 'p21b', title: 'Technical Camera Texture Swap', category: 'multi-clipping-path-service', serviceName: 'Multi-Clipping', beforeImage: '/camera-before.png?v=2', afterImage: '/camera-after.png?v=2', featured: true },
  { id: 'p21c', title: 'Transparent Lens Recolor', category: 'multi-clipping-path-service', serviceName: 'Multi-Clipping', beforeImage: '/sunglasses-before.png?v=2', afterImage: '/sunglasses-after.png?v=2', featured: true },
